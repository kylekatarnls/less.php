...
class ParserTest
{
    ...
    public $dir;
    public $test_dirs = array('lessjs', 'bootstrap3');
    public $cache_dir;
    public $head;
     ...
     */
    public function PHPDiff($compiled, $css, $force = false)
    {
     ...
     * Error Handling.
     */
    public static function showError($errno, $errmsg, $filename, $linenum, $vars)
    {
